...
export const paths = {
  ...
  auth: {
    ...
    jwt: {
      ...
      passwordcode: `${ROOTS.AUTH}/jwt/password-code`,
      newpassword: `${ROOTS.AUTH}/jwt/new-password`,
      continue: `${ROOTS.AUTH}/jwt/continue`,
    },
    firebase: {
  ...
  dashboard: {
    ...
    employee: {
      ...
      details: (id: string) => `${ROOTS.DASHBOARD}/employee/${id}`,
      edit: (id: string) => `${ROOTS.DASHBOARD}/employee/${id}/edit`,
      demo: {
        details: `${ROOTS.DASHBOARD}/employee/${MOCK_ID}`,
